 ...
 * @since R9.0
 */
public class Case6_2_5_2 {

    /**
     * logger
     */
    private static final Logger logger = LoggerFactory.getLogger(Case6_2_5_2.class);
    ...
    private static class OneInstanceService {
        ...
        private volatile static OneInstanceService instance;

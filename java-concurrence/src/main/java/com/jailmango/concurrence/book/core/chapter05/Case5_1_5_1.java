...
/**
 * 5.1.5.1 测试schedule()方法任务不延时——Date类型 <br/>
 ...
 * @since R9.0
 */
public class Case5_1_5_1 {

    /**
     * logger
     */
    private static final Logger logger = LoggerFactory.getLogger(Case5_1_5_1.class);
    ...
    public static void main(String[] args) {
        ...
        timer.schedule(task, new Date(now), 2000);
    }
